...
public class CommunityEventsActivity extends BasePrivateActivity {
    private ArrayAdapter<Event> adpCommunityEvents;
    ...
    private void setUpViews() {
        ListView lstCommunityEvents = (ListView) findViewById(R.id.lst_community_events);
        adpCommunityEvents = new ArrayAdapter<Event>(this, 0) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                View view;
                if (convertView == null) {
                    view = mInflater.inflate(R.layout.view_community_event, parent, false);
                } else {
                    view = convertView;
                }

                TextView txtName = (TextView) view.findViewById(R.id.txt_community_event);
...
//                                        product.setStock(product.getStock() - 1);
                                        adpCommunityEvents.notifyDataSetChanged();

                                        Intent i = new Intent(CommunityEventsActivity.this, EventActivity.class);
        ...
        lstCommunityEvents.setAdapter(adpCommunityEvents);
    }
    ...
    protected void refreshViews() {
        ...
        adpCommunityEvents.clear();

        startProgress();

        ApiRouter.withToken(getCurrentUser().getToken()).getCommunityEvents(communityId, new Callback<List<Event>>() {
            @Override
            public void success(List<Event> events, Response response) {
                adpCommunityEvents.addAll(events);
                stopProgress();
            }
